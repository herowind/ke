...
class CommonMod extends Model
{
    ...
    {
        $role = AdminLoginSvc::getRole();
        switch ($role){
        	case 'superadmin':
        		break;
        	case 'agent':
        		$query->where('agent_id', '=', AdminLoginSvc::getAgentId());
        		break;
        	case 'staff':
        		$query->where('agent_id', '=', AdminLoginSvc::getAgentId())->where('admin_id','=',AdminLoginSvc::isLogin());
        		break;
        }
